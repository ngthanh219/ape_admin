...
$(document).on('click', '.table-data .update-status', function (e) {
  ...
  $.ajax({
    url: _base_js__WEBPACK_IMPORTED_MODULE_0__.apiUrl + 'user-data/' + userId,
    type: 'PUT',
    headers: {
...
function getUserData() {
  ...
  $.ajax({
    url: _base_js__WEBPACK_IMPORTED_MODULE_0__.apiUrl + 'user-data',
    type: 'GET',
    dataType: 'json',
    data: requestData,
    success: function success(res) {
      if (res.success === 1) {
        ...
        if (responseData.data.length == 0) {
          ...
          if (responseData.user_agent != null) {
            ...
            userAgent += "<td class=\"text-left\">\n                                         <span>App version: ".concat(responseData.user_agent["app_version"], "</span></br>\n                                         <span>Os version: ").concat(responseData.user_agent["os_version"], "</span>\n                                     </td>");
          } else {
