...
(() => {
/*!*******************************************!*\
  !*** ./resources/js/system-mode/index.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
...
function getSystemConfigData() {
  ...
  var url = _base_js__WEBPACK_IMPORTED_MODULE_0__.apiUrl + 'system-mode-data';
  $.ajax({
    url: url,
    type: 'GET',
    dataType: 'json',
    success: function success(res) {
      if (res.success === 1) {
        $.each(res.data, function (index, data) {
          $("#system-mode-data").append("\n                        <button data-mode=\"".concat(data["id"], "\" id=\"switch-mode-").concat(data["id"], "\" class=\"btn btn-outline-danger").concat(data.status == 1 ? ' bg-danger' : '', "\">").concat(data.name, "</button>\n                    "));
        });
      } else {
...
function switchMode(modeId) {
  (0,_base_js__WEBPACK_IMPORTED_MODULE_0__.onLoading)();
  $.ajax({
    url: _base_js__WEBPACK_IMPORTED_MODULE_0__.apiUrl + 'system-mode-data/' + modeId,
    type: 'PUT',
    headers: {
