...
function getEventTypeData() {
  ...
  $.ajax({
    url: _base_js__WEBPACK_IMPORTED_MODULE_0__.apiUrl + 'event-data',
    type: 'GET',
    dataType: 'json',
    data: requestData,
