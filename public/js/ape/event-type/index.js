...
(() => {
/*!******************************************!*\
  !*** ./resources/js/event-type/index.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
...
function btnPaginate() {
  if (eventTypeParams.offset == eventTypeParams.totalPage) $('#paginate-right').addClass('disabled');else $('#paginate-right').removeClass('disabled');
  if (eventTypeParams.offset == 1) $('#paginate-left').addClass('disabled');else $('#paginate-left').removeClass('disabled');
}
...
function getEventTypeData() {
  ...
  $.ajax({
    url: _base_js__WEBPACK_IMPORTED_MODULE_0__.apiUrl + 'event-type-data',
    type: 'GET',
    dataType: 'json',
    data: requestData,
      ...
      if (res.success === 1) {
        ...
        if (responseData.data.length == 0) {
          ...
          $.each(responseData.data, function (index, data) {
            html += "\n                            <tr>\n                                <td><b>".concat(data["id"], "</b></td>\n                                <td>").concat(data["name"], "</td>\n                                <td>\n                                    ").concat(data["deleted"] == 0 ? '<span class="badge bg-primary">Using</span>' : '<span class="badge bg-danger">Deleted</span>', "\n                                </td>\n                                <td class=\"d-flex justify-content-between\">\n                                    <a href=\"").concat(_base_js__WEBPACK_IMPORTED_MODULE_0__.url, "/event-type/").concat(data["id"], "\" class=\"btn btn-outline-primary btn-sm mr-2\">\n                                        <i class=\"nav-icon fas fa-edit ml-1\"></i>\n                                    </a>\n                                </td>\n                            </tr>\n                        ");
            i++;
          });
        }
